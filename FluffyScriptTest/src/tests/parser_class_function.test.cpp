...
namespace fluffy { namespace testing {
	...
	TEST_F(ParserClassFunctionTest, TestFunctionNoModNoParamsNoRet)
	{
		...
		EXPECT_EQ(classObject->functionList[0]->accessModifier, ast::ClassMemberAccessModifier_e::Private);
		...
		EXPECT_EQ(classObject->functionList[0]->returnType->typeID, ast::TypeDeclID_e::Void);
	}
	...
	TEST_F(ParserClassFunctionTest, TestFunctionNoModWithOnlyOneParamNoRet)
	{
		...
		EXPECT_EQ(classObject->functionList[0]->parameterList[0]->typeDecl->typeID, ast::TypeDeclID_e::I32);
	...
	TEST_F(ParserClassFunctionTest, TestFunctionNoModWithMultiplesParamsNoRet)
	{
		...
		EXPECT_EQ(classObject->functionList[0]->parameterList[1]->typeDecl->typeID, ast::TypeDeclID_e::String);
	...
	TEST_F(ParserClassFunctionTest, TestFunctionNoModWithMultiplesParamsWithRet)
	{
		...
		EXPECT_EQ(classObject->functionList[0]->returnType->typeID, ast::TypeDeclID_e::I32);
	}
	...
	TEST_F(ParserClassFunctionTest, TestVirtualFunctionWithModWithMultiplesParamsWithRetWithFinal)
	{
		...
		EXPECT_EQ(classObject->functionList[0]->accessModifier, ast::ClassMemberAccessModifier_e::Protected);
	...
	TEST_F(ParserClassFunctionTest, TestStaticFunctionNoModWithMultiplesParamsWithRet)
	{
		...
		EXPECT_EQ(classObject->staticFunctionList[0]->accessModifier, ast::ClassMemberAccessModifier_e::Private);
		...
		EXPECT_EQ(classObject->staticFunctionList[0]->parameterList[0]->typeDecl->typeID, ast::TypeDeclID_e::I32);

		EXPECT_EQ(classObject->staticFunctionList[0]->parameterList[1]->identifier, "test2");
		EXPECT_EQ(classObject->staticFunctionList[0]->parameterList[1]->typeDecl->typeID, ast::TypeDeclID_e::String);

		EXPECT_EQ(classObject->staticFunctionList[0]->returnType->typeID, ast::TypeDeclID_e::I32);
	}
	...
	TEST_F(ParserClassFunctionTest, TestStaticFunctionNoModWithMultiplesParamsWithRetWithGeneric)
	{
		...
		EXPECT_EQ(classObject->staticFunctionList[0]->genericTemplateList[0]->whereTypeList[0]->typeID, ast::TypeDeclID_e::I32);
		EXPECT_EQ(classObject->staticFunctionList[0]->genericTemplateList[0]->whereTypeList[0]->nullable, false);
		EXPECT_EQ(classObject->staticFunctionList[0]->genericTemplateList[0]->whereTypeList[1]->typeID, ast::TypeDeclID_e::Fp32);
